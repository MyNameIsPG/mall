...
import com.pg.mall.product.service.UserAddressService;
...
public class UserAddressController {
    ...
    public R info(@PathVariable("uuid") String uuid){
		UserAddressEntity userAddress = userAddressService.getById(uuid);
    ...
    public R delete(@RequestBody String[] uuids){
		userAddressService.removeByIds(Arrays.asList(uuids));
